<?php
    require_once('functions/search_city_times.php');
            ...
            <div class="result-cards">
                <div class="result-card">
                    <div class="result-card__img-wrapper">
                        <img src="/php03/img/<?php echo $tokyo['img']?>" alt="国旗" class="result-card__img">
                    </div>
                ...
                <div class="result-card">
                    <div class="result-card__img-wrapper">
                        <img src="/php03/img/<?php echo $comparison['img']?>" alt="国旗" class="result-card__img">
                    </div>
                    <div class="result-card__body">
